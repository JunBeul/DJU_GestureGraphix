<template>
  <div class="warp">
    <div class="gridWarp">
      <div class="bgFile anime" v-for="dataList in user">
        <img src="{{ dataList.imgSrc }}" alt="">
        <div class="textBox">
          <p>{{dataList.fileName}}</p>
          <button type="button" class="icon anime" @click="bgDel">
      ...
      <div class="bgUpload anime" @click="bgUpload">
        <input type="file" id="file" @change="fileChange">
        <div class="icon">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M409 103v306H103V103h306m9-27H94c-9.94 0-18 8.06-18 18v324c0 9.94 8.06 18 18 18h324c9.94 0 18-8.06 18-18V94c0-9.94-8.06-18-18-18Z"/><path d="M269.5 148h-27a9 9 0 0 0-9 9v76.5H157a9 9 0 0 0-9 9v27a9 9 0 0 0 9 9h76.5V355a9 9 0 0 0 9 9h27a9 9 0 0 0 9-9v-76.5H355a9 9 0 0 0 9-9v-27a9 9 0 0 0-9-9h-76.5V157a9 9 0 0 0-9-9Z"/></svg>
        </div>
        <p class="anime">배경 업로드</p>
      </div>
    </div>
  </div>
</template>
